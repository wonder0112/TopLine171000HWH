...
public class Constant {
    public static final String WEB_SITE = "http://61.142.174.202:8080/topline";
    ...
    public static final String REQUEST_CHOOSE_CONSTELLATION_URL = "/choose_constellation_list_data.json";
}
